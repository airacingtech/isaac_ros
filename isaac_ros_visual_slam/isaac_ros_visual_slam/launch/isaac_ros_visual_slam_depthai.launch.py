...
def generate_launch_description():
    ...
    params_file = os.path.join(nvidia_slam_prefix, 'config', 'depthai.yaml')
    ...
    visual_slam_node = ComposableNode(
        ...
        remappings=[('visual_slam/image_0', '/oak/left/image_raw'),
    ...
    return launch.LaunchDescription([
        SetEnvironmentVariable('DEPTHAI_WATCHDOG_INITIAL_DELAY', '60000'),
        SetEnvironmentVariable('DEPTHAI_BOOTUP_TIMEOUT', '60000'),
        depthai, 
        delayed_vslam
        ])
